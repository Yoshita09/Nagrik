      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Ticket ID: #ISS-005</p>
              </div>
            </div>

            <p className="mt-4 text-gray-600">
              Blocked drain causing water logging during rain.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <Info icon={MapPin} label="Location" value="Richmond Road, Junction, Ward 3" />
              <Info icon={AlertCircle} label="Department" value="Water Supply" />
              <Info icon={Calendar} label="Reported On" value="January 2, 2024" />
              <Info icon={User} label="Reported By" value="Citizen202" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <Timeline icon={CheckCircle} title="Reported" time="Jan 2, 2024 — 5:30 AM" active />
            <Timeline icon={CheckCircle} title="Acknowledged" time="Jan 2, 2024 — 6:30 AM" active />
            <Timeline icon={CheckCircle} title="In Progress" time="Jan 3, 2024 — 5:30 AM" active />
            <Timeline icon={CheckCircle} title="Resolved" time="Jan 6, 2024 — 5:30 AM" active />
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <Stat label="Category" value="Sewage" />
