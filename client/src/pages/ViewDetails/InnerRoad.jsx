...
export default function MultiplePotholes() {
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <h2 className="text-xl font-semibold">
                  Multiple potholes on inner road
                </h2>
                <p className="text-sm text-gray-500">Ticket ID: #ISS-006</p>
              </div>
            </div>

            <p className="mt-4 text-gray-600">
              Several potholes making road unusable.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <Info icon={MapPin} label="Location" value="Church Street, Lane 3, Ward 3" />
              <Info icon={AlertCircle} label="Department" value="Roads & Infrastructure" />
              <Info icon={Calendar} label="Reported On" value="January 11, 2024" />
              <Info icon={User} label="Reported By" value="Citizen303" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <Timeline icon={CheckCircle} title="Reported" time="Jan 11, 2024 — 5:30 AM" active />
            <Timeline icon={CheckCircle} title="Acknowledged" time="Jan 11, 2024 — 6:30 AM" active />
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <div className="bg-gray-50 p-4 rounded-xl mb-5">
              ...
              <p className="text-sm text-gray-600 mt-2">
                Your complaint has been received and assigned to the Roads & Infrastructure.
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <Stat label="Category" value="Pothole" />
            <Stat label="Similar Issues" value="1" />
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <div className="bg-gray-50 p-4 rounded-xl">
              <p className="font-medium">Large pothole on MG Road</p>
              <p className="text-xs text-gray-500">Ward 1</p>
            </div>
          </div>
