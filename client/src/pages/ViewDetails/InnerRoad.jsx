          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                <Info
                  icon={MapPin}
                  label="Location"
                  value="Church Street, Lane 3, Ward 3"
                />
                <Info
                  icon={AlertCircle}
                  label="Department"
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <Timeline
                icon={CheckCircle}
                title="Reported"
                time="Jan 11, 2024 — 5:30 AM"
                active
              />
              <Timeline
                icon={CheckCircle}
                title="Acknowledged"
                time="Jan 11, 2024 — 6:30 AM"
                active
              />
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <button className="mt-4 bg-primary text-white px-5 py-2 rounded-xl
