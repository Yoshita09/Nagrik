      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <h2 className="text-xl font-semibold">
                  Garbage overflow at bin
                </h2>
                <p className="text-sm text-gray-500">Ticket ID: #ISS-003</p>
              </div>
            </div>

            <p className="mt-4 text-gray-600">
              Community bin overflowing, attracting stray animals.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <Info icon={MapPin} label="Location" value="Residency Road, Block B, Ward 2" />
              <Info icon={AlertCircle} label="Department" value="Sanitation & Waste" />
              <Info icon={Calendar} label="Reported On" value="January 10, 2024" />
              <Info icon={User} label="Reported By" value="Citizen789" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <Timeline icon={CheckCircle} title="Reported" time="Jan 10, 2024 — 5:30 AM" active />
            <Timeline icon={CheckCircle} title="Acknowledged" time="Jan 10, 2024 — 6:30 AM" active />
            <Timeline icon={Loader} title="In Progress" time="Jan 11, 2024 — 5:30 AM" active />
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <div className="bg-gray-50 p-4 rounded-xl mb-5">
              ...
              <p className="text-sm text-gray-600 mt-2">
                Your complaint has been received and assigned to the Sanitation & Waste Department.
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <Stat label="Category" value="Garbage" />
