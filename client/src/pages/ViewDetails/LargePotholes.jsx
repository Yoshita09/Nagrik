        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <Info icon={MapPin} label="Location" value="MG Road, Near Metro Station, Ward 1" />
              <Info icon={AlertCircle} label="Department" value="Roads & Infrastructure" />
              <Info icon={Calendar} label="Reported On" value="January 5, 2024" />
              <Info icon={User} label="Reported By" value="Citizen123" />
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <div className="bg-gray-50 p-4 rounded-xl">
              <p className="font-medium">Multiple potholes on inner road</p>
              <p className="text-xs text-gray-500">Ward 3</p>
            </div>
          </div>
